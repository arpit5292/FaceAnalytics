...
from .mtcnn_util import detect_face, extract_face
...
class PNet(nn.Module):
    ...
    def __init__(self, modelWeights):
        ...
        state_dict_path = modelWeights#os.path.join(os.path.dirname(__file__), '../data/pnet.pt')
...
class RNet(nn.Module):
    ...
    def __init__(self, modelWeights):
        ...
        state_dict_path = modelWeights#os.path.join(os.path.dirname(__file__), '../data/rnet.pt')
        state_dict = torch.load(state_dict_path)
        self.load_state_dict(state_dict)
...
class ONet(nn.Module):
    ...
    def __init__(self, modelWeights):
        ...
        state_dict_path = modelWeights#os.path.join(os.path.dirname(__file__), '../data/onet.pt')
        state_dict = torch.load(state_dict_path)
        self.load_state_dict(state_dict)
...
class MTCNN(nn.Module):
    ...
    def __init__(
        ...
        select_largest=True, selection_method=None, keep_all=False, device=None,weights='./data/weights/'
    ):
        super().__init__()
        ...
        self.pnet = PNet(os.path.join(weights,'pnet.pt'))
        self.rnet = RNet(os.path.join(weights,'rnet.pt'))
        self.onet = ONet(os.path.join(weights,'onet.pt'))
